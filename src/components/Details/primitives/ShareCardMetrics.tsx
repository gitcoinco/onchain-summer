...
import { Users, ArrowRightLeft, Activity, MessageSquare, DollarSign, Droplet, ArrowBigDownDash, ActivitySquareIcon, ArrowDownSquare } from "lucide-react"
    ...
    return (
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="text-sm font-semibold">{getMetric(project, "farcaster_users_90D")}</div>
            ...
            <div className="space-y-2">
                <div className="text-sm font-semibold">{getMetric(project, "num_drops")}</div>
                <div className="text-sm font-semibold">{getMetric(project, "num_unique_minters")}</div>
                <div className="text-sm font-semibold">{getMetric(project, "num_transactions")}</div>
                <div className="text-sm font-semibold">{getMetric(project, "usd_value_of_transactions")}</div>
                <div className="text-sm font-semibold">{getMetric(project, "num_farcaster_minters")}</div>
                <div className="text-sm font-semibold">{getMetric(project, "num_farcaster_transactions")}</div>
